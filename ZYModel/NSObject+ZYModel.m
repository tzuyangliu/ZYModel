...
NS_INLINE void SetNSObjectToProperty(id target, ZYClassPropertyInfo *property,
                                     id value) {
  id setterObject = nil;
  ...
  case ZYEncodingTypeNSMutableArray: {
    ...
    if (array) {
      if (property->_containCls) {
        ...
        setterObject =
            (nsType == ZYEncodingTypeNSArray) ? finalArray.copy : finalArray;
      } else {
        setterObject =
            (nsType == ZYEncodingTypeNSArray) ? array : array.mutableCopy;
      }
    }
    break;
  }
  ...
  case ZYEncodingTypeNSMutableSet: {
    ...
    if (set) {
      if (property->_hasCustomContainCls) {
        ...
        setterObject =
            (nsType == ZYEncodingTypeNSSet) ? finalSet.copy : finalSet;
      } else {
...
NS_INLINE void SetCNumberToProperty(id target, ZYClassPropertyInfo *property,
                                    NSNumber *number) {
...
NS_INLINE void SetValueToProperty(id target, ZYClassPropertyInfo *property,
                                  id value) {
...
static void ModelSetWithPropertyMetaArrayFunction(const void *_propertyMeta,
  ...
  __unsafe_unretained ZYModelPropertyTransformInfo *propertyMeta =
      (__bridge ZYModelPropertyTransformInfo *)(_propertyMeta);
  if (!propertyMeta->_classProperty->_setter)
    return;
  id value = nil;
  ...
  for (ZYModelPropertyTransformInfo *propertyMeta in modelMeta
    ...
    if (propertyMeta->_classProperty->_isCNumber) {
      ...
      id v = ((id (*)(id, SEL))(void *)objc_msgSend)(
          (id)model, propertyMeta->_classProperty->_getter);
