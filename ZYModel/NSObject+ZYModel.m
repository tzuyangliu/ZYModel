...
NS_INLINE void SetNSObjectToProperty(id target, ZYModelPropertyTransformInfo* property,
    id value)
{
    id setterObject = nil;
...
NS_INLINE void SetCNumberToProperty(id target, ZYModelPropertyTransformInfo* property,
    NSNumber* number)
{
...
NS_INLINE void SetValueToProperty(id target, ZYModelPropertyTransformInfo* property,
    id value)
{
