...
- (void)setUp {
  ...
  NSError *error = nil;
  NSString *filePath =
      [[NSBundle bundleForClass:[self class]] pathForResource:@"demo"
                                                       ofType:@"json"];
...
- (void)checkNSClassWithDemoClassObject:(DemoClass *)obj {
  ...
  // NSMutableDictionary
  XCTAssert(
      [obj.nsMutableDictionary isKindOfClass:[NSMutableDictionary class]]);
...
- (void)testModelToJson {
  ...
  [json enumerateKeysAndObjectsUsingBlock:^(NSString *key, id _Nonnull obj,
                                            BOOL *_Nonnull stop) {
